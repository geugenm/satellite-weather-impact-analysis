...
meta:
  id: bdsat2
  title: BDSAT-2 beacon decoder www.bdsat.cz
  endian: le
doc: |
  ...
  bds:
    seq:
      ...
      - id: bds_tmp_e2_3_str
        ...
        encoding: utf8
        doc: "bds_tmp_e2_3"
      - id: bds_tmp_ei_0_w_str
        type: str
        terminator: 0x2E
        encoding: utf8
        doc: "bds_tmp_ei_0_w"
      - id: bds_tmp_ei_0_d_str
        type: str
        terminator: 0x2C
        encoding: utf8
        doc: "bds_tmp_ei_0_d"
      - id: bds_tmp_ei_1_w_str
        type: str
        terminator: 0x2E
        encoding: utf8
        doc: "bds_tmp_ei_1_w"
      - id: bds_tmp_ei_1_d_str
        type: str
        terminator: 0x2C
        encoding: utf8
        doc: "bds_tmp_ei_1_d"
      - id: bds_pres_ei_0_w_str
        type: str
        terminator: 0x2E
        encoding: utf8
        doc: "bds_pres_ei_0_w"
      - id: bds_pres_ei_0_d_str
        type: str
        terminator: 0x2C
        encoding: utf8
        doc: "bds_pres_ei_0_d"
      - id: bds_pres_ei_1_w_str
        type: str
        terminator: 0x2E
        encoding: utf8
        doc: "bds_pres_ei_1_w"
      - id: bds_pres_ei_1_d_str
        type: str
        size-eos: true
        encoding: utf8
        doc: "bds_pres_ei_1"
    ...
    instances:
      bds_hwstate_int:
        value: bds_hwstate.to_i
      bds_tmp_c0:
        value: bds_tmp_c0_str.to_i
      bds_tmp_c1:
        value: bds_tmp_c1_str.to_i
      bds_tmp_e1_0:
        value: bds_tmp_e1_0_str.to_i
      bds_tmp_e1_1:
        value: bds_tmp_e1_1_str.to_i
      bds_tmp_e1_2:
        value: bds_tmp_e1_2_str.to_i
      bds_tmp_e1_3:
        value: bds_tmp_e1_3_str.to_i
      bds_tmp_e2_0:
        value: bds_tmp_e2_0_str.to_i
      bds_tmp_e2_1:
        value: bds_tmp_e2_1_str.to_i
      bds_tmp_e2_2:
        value: bds_tmp_e2_2_str.to_i
      bds_tmp_e2_3:
        value: bds_tmp_e2_3_str.to_i
      bds_tmp_ei_0_float:
        value: bds_tmp_ei_0_w_str.to_i.as<f4> + (bds_tmp_ei_0_d_str.to_i.as<f4>*0.01)
      bds_tmp_ei_1_float:
        value: bds_tmp_ei_1_w_str.to_i.as<f4> + (bds_tmp_ei_1_d_str.to_i.as<f4>*0.01)
      bds_pres_ei_0_float:
        value: bds_pres_ei_0_w_str.to_i.as<f4> + (bds_pres_ei_0_d_str.to_i.as<f4>*0.001)
      bds_pres_ei_1_float:
        value: bds_pres_ei_1_w_str.to_i.as<f4> + (bds_pres_ei_1_d_str.to_i.as<f4>*0.001)
