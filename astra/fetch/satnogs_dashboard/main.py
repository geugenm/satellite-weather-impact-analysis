...
def parse_grafana_url(url: str) -> str:
    """Extract and normalize Grafana dashboard URL"""
    parsed = urlparse(url)
...
def build_inspection_url(base_url: str, panel_id: str) -> str:
    """Build panel inspection URL with required parameters"""
...
async def grafana_fetch(url: str, output_dir: Path):
    ...
    logging.info("processing dashboard: %s", base_url)
